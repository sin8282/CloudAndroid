...
public class VideoFolderAdapter extends RecyclerView.Adapter<VideoFolderAdapter.CustomViewHolder> {
    ...
    public VideoFolderAdapter(View viewPagerView, AutoFitViewModuler recyclerView, List<StroageBucketVO> bucketList, RequestManager glide) {
    ...
    @NonNull
    @Override
    public VideoFolderAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_bucketlist, parent, false);
        return new VideoFolderAdapter.CustomViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull VideoFolderAdapter.CustomViewHolder holder, int position) {
